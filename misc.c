...
struct subscribers
{
    int subscriber_pid; /* PID of the subscriber process */
    MSG_BUF head_of_list; /*How many messages should the subscriber read */
};


struct publishers
{
    int publisher_pid; /* PID of the publishers process */
};
